...
SEARCH_FROM_RAGFLOW_FUNCTION_DESC = {
    ...
    "function": {
        ...
        "description": "Search the knowledge base for communication coaching books, relationship advice, communication techniques, conflict resolution strategies, emotional intelligence guidance, and any information related to improving interpersonal communication and relationships. Use this when users ask about communication skills, relationship problems, how to express feelings, how to listen better, conflict resolution, or when you need authoritative information from communication coaching books.",
        "parameters": {
            "type": "object",
            "properties": {"question": {"type": "string", "description": "The question or topic to search for in the knowledge base (e.g., 'how to express needs without criticism', 'active listening techniques', 'conflict resolution steps')"}},
            "required": ["question"],
        },
    },
}
