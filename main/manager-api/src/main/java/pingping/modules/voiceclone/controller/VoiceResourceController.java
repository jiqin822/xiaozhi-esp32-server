package pingping.modules.voiceclone.controller;
...
import pingping.modules.voiceclone.dto.VoiceCloneDTO;
import pingping.modules.voiceclone.dto.VoiceCloneResponseDTO;
...
public class VoiceResourceController {
    ...
    public Result<Void> save(@RequestBody VoiceCloneDTO dto) {
        ...
        } catch (pingping.common.exception.RenException e) {
