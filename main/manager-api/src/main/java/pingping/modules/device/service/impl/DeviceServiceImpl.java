package pingping.modules.device.service.impl;
...
import pingping.common.utils.DateUtils;
import pingping.modules.device.dao.DeviceDao;
import pingping.modules.device.dto.DeviceManualAddDTO;
import pingping.modules.device.dto.DevicePageUserDTO;
import pingping.modules.device.dto.DeviceReportReqDTO;
import pingping.modules.device.dto.DeviceReportRespDTO;
import pingping.modules.device.entity.DeviceEntity;
import pingping.modules.device.entity.OtaEntity;
import pingping.modules.device.service.DeviceService;
import pingping.modules.device.service.OtaService;
import pingping.modules.device.vo.UserShowDeviceListVO;
...
public class DeviceServiceImpl extends BaseServiceImpl<DeviceDao, DeviceEntity> implements DeviceService {
    ...
    public DeviceReportRespDTO checkDeviceActive(String macAddress, String clientId,
        ...
        if (StringUtils.isBlank(wsUrl) || wsUrl.equals("null")) {
            ...
            wsUrl = "ws://pingping.server.com:8000/xiaozhi/v1/";
            ...
            if (wsUrls.length > 0) {
                ...
                log.error("WebSocket地址未配置，请登录智控台，在参数管理找到【server.websocket】配置");
                websocket.setUrl("ws://pingping.server.com:8000/xiaozhi/v1/");
            }
        }
