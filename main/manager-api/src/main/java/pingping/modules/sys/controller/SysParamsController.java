package pingping.modules.sys.controller;
...
import pingping.common.annotation.LogOperation;
...
import pingping.common.validator.group.AddGroup;
import pingping.common.validator.group.DefaultGroup;
import pingping.common.validator.group.UpdateGroup;
import pingping.modules.config.service.ConfigService;
import pingping.modules.sys.dto.SysParamsDTO;
import pingping.modules.sys.service.SysParamsService;
import pingping.modules.sys.utils.WebSocketValidator;
...
public class SysParamsController {
    ...
    private void validateVoicePrint(String paramCode, String url) {
        ...
        try {
            ...
            log.error("Voiceprint interface connection failed: {}", e.getMessage());
            throw new RenException(ErrorCode.VOICEPRINT_INTERFACE_ACCESS_FAILED);
        } catch (org.springframework.web.client.HttpClientErrorException | org.springframework.web.client.HttpServerErrorException e) {
            // HTTP error response
            log.error("Voiceprint interface HTTP error: {} - {}", e.getStatusCode(), e.getMessage());
            throw new RenException(ErrorCode.VOICEPRINT_INTERFACE_ACCESS_FAILED);
        } catch (Exception e) {
            // Other exceptions
            log.error("Voiceprint interface validation failed: {}", e.getMessage(), e);
    ...
    private void validateMqttSecretLength(String paramCode, String secret) {
        ...
        // 不允许包含弱密码
        String[] weakPasswords = { "test", "1234", "admin", "password", "qwerty", "pingping" };
